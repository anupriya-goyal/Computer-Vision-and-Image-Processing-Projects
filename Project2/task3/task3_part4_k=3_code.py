...
centroid = np.array([[[img[0][0][0],img[0][0][1],img[0][0][2]],[img[0][1][0],img[0][1][1],img[0][1][2]],[img[0][2][0],img[0][2][1],img[0][2][2]]]])
...
#print(final_cluster2_xy_values)
#print(len(final_cluster2_xy_values[0]))   
...
#print(final_cluster3_xy_values)
#print(len(final_cluster3_xy_values[0]))
...
cv2.imwrite("task3_part4_k3.jpg",img)    
